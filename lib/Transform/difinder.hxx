...
namespace cage::di
{
  namespace compat
  {
    ...
    llvm::Value*
    get_alloca_for (DbgVar const* dbg_var)
    {
  ...
  inline std::optional<llvm::DbgVariableIntrinsic const*>
  find_intrinsic (llvm::Instruction const* inst)
  {
    if (!inst)
      return {};
  ...
  inline std::optional<llvm::DbgVariableRecord const*>
  find_intrinsic (llvm::Instruction const* root)
  {
    if (!root)
      return {};
  ...
  inline llvm::DILocation const*
  location (llvm::Instruction const* inst)
  {
