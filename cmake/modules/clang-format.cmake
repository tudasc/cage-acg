function(cage_add_format_target target comment)
  ...
  cage_find_llvm_progs(cage_CLANG_FORMAT_EXEC
    "clang-format-${LLVM_VERSION_MAJOR};clang-format"
  )
  if(cage_CLANG_FORMAT_EXEC)
    add_custom_target(${target}
      COMMAND ${cage_CLANG_FORMAT_EXEC} -i -style=file ${ARG_OTHER} ${ARG_UNPARSED_ARGUMENTS}
              ${ALL_CXX_FILES}
