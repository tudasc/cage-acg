...
libgenCC=@libgenCC@
libgenCC_path=$(dirname "${libgenCC}")
runtimeComponent=@runtimeComponent@
runtimeComponent_path=$(dirname "${runtimeComponent}")
pluginCapableLLD=@pluginCapableLLD@


export LD_LIBRARY_PATH="$LD_LIBRARY_PATH":"$runtimeComponent":"$libgenCC"
...
$pluginCapableLLD --hash-style=both --build-id --eh-frame-hdr -m elf_x86_64 -dynamic-linker /lib64/ld-linux-x86-64.so.2 -o a.out /lib/x86_64-linux-gnu/crt1.o /lib/x86_64-linux-gnu/crti.o /usr/bin/../lib/gcc/x86_64-linux-gnu/10/crtbegin.o -L${runtimeComponent_path} -L/usr/bin/../lib/gcc/x86_64-linux-gnu/10 -L/usr/bin/../lib/gcc/x86_64-linux-gnu/10/../../../../lib64 -L/lib/x86_64-linux-gnu -L/lib/../lib64 -L/usr/lib/x86_64-linux-gnu -L/usr/lib/../lib64 -L/usr/lib/llvm-13/bin/../lib -L/lib -L/usr/lib -plugin /usr/lib/llvm-13/bin/../lib/LLVMgold.so -plugin-opt=mcpu=x86-64 -plugin-opt=O3 -save-temps --lto-O3 --lto-load-pass-plugin=$libgenCC --lto-newpm-passes=$O3_with_genCC_passes *.bc -lgenCCRT -lstdc++ -lm -lgcc_s -lgcc -lc -lgcc_s -lgcc /usr/bin/../lib/gcc/x86_64-linux-gnu/10/crtend.o /lib/x86_64-linux-gnu/crtn.o
