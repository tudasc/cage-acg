...
libgenCC=/home/tim/Dokumente/Projekte/PA_Fortran/gencc/cmake-build-debug/lib/libplugin.so
runtimeComponent=/home/tim/Dokumente/Projekte/PA_Fortran/gencc/cmake-build-debug/lib/Runtime/libgenCCRT.so
...
function main_in(){
  ...
  for single_link in ${clang_link_invoke[@]}; do
    ...
    split_link+=("-L${runtimeComponent_path} -rpath ${runtimeComponent_path} -lgenCCRT --lto-load-pass-plugin=$libgenCC --lto-newpm-passes='genCC'")
